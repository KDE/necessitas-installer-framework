...
QtPatchOperation2::QtPatchOperation2()
{
    setName(QLatin1String("QtPatch2"));
}
...
void QtPatchOperation2::backup()
{
}

bool QtPatchOperation2::performOperation()
{
    // Arguments:
    // 1. new/target qtpath
...
#endif
        filesToPatch<<QLatin1String("lib/libQtCore.so");
...
bool QtPatchOperation2::undoOperation()
{
    return true;
}

bool QtPatchOperation2::testOperation()
{
    return true;
}

Operation* QtPatchOperation2::clone() const
{
    return new QtPatchOperation2();
}
